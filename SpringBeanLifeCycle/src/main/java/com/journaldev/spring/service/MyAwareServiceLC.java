 ...
 * @version 0.3.1
 */
public class MyAwareServiceLC implements ApplicationContextAware,
		ApplicationEventPublisherAware, BeanClassLoaderAware, BeanFactoryAware,
		BeanNameAware, EnvironmentAware, ImportAware, ResourceLoaderAware {

	@PostConstruct
	public void init(){
		System.out.println("MyAwareServiceLC init method called");
	}
	
	public MyAwareServiceLC(){
		System.out.println("MyAwareServiceLC no-args constructor called");
	}
	
	@PreDestroy
	public void destory(){
		System.out.println("MyAwareServiceLC destroy method called");
	}
